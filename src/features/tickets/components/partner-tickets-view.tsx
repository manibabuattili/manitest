...
export function PartnerTicketsView({
  ...
  useEffect(() => {
    if (filterOpen) setDraft(filtersFromParams(searchParams));
                    ...
                    <div className="relative">
                      <button
                        ...
                        className={cn(
                          ...
                          (menuOpen || filterOpen || activeFilterCount > 0) && "text-brand-700"
                        )}
                        aria-label="Ticket ID options"
                        onClick={(e) => {
                          e.stopPropagation();
                          setFilterOpen(false);
                          setMenuOpen((v) => !v);
                      ...
                      >
                        ...
                        {activeFilterCount > 0 && (
                          <span className="absolute -right-0.5 -top-0.5 h-1.5 w-1.5 rounded-full bg-brand-600" />
                        )}
                      </button>
                      ...
                      {menuOpen && (
                        <>
                          ...
                          />
                          <div className="absolute left-0 top-full z-40 mt-1 w-40 overflow-hidden rounded-xl border border-gray-200 bg-white py-1 shadow-xl">
                            <button
                              type="button"
                            ...
                            >
                              ...
                              Filter
                              {activeFilterCount > 0 && (
                                <span className="ml-auto rounded-full bg-brand-50 px-1.5 text-[10px] font-semibold text-brand-700">
                                  {activeFilterCount}
                                </span>
                              )}
                            </button>
                      ...
                      {filterOpen && (
                        <>
                          ...
                          />
                          <div className="absolute left-0 top-full z-40 mt-1 w-[320px] overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-xl">
                              ...
                              >
                                <FilterOption
                                  ...
                                  onChange={() =>
                                    setDraft((d) => ({
                                      ...d,
                                      slaBreached: toggleValue(d.slaBreached, "yes") as Array<
                                        "yes" | "no"
                                      >,
                                    }))
                                  }
                                ...
                                <FilterOption
                                  ...
                                  onChange={() =>
                                    setDraft((d) => ({
                                      ...d,
                                      slaBreached: toggleValue(d.slaBreached, "no") as Array<
                                        "yes" | "no"
                                      >,
                                    }))
                                  }
